...
# 4. Права
sudo chown -R prohorov:sudo /mlopsnew
...
# 4. Права
sudo chown -R prohorov:sudo /home/prohorov/.cache/huggingface
sudo chmod -R 2775 /home/prohorov/.cache/huggingface
```
...
---
*Документация по бэкапам обновляется при изменении процедур или конфигураций*
